...
@property (assign, nonatomic) NSInteger selectedMenuItem;

@end

@implementation XASMenuTableViewController
...
- (void)viewDidLoad {
    ...
    _menuItems = @[@"home", @"profile", @"today", @"venues", @"likes", @"search"];
    _selectedMenuItem = 1;
